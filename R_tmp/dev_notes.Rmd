...
# Install the package with vignettes, but vignettes are not available for users
devtools::install(build_vignettes = TRUE)
# make a tarball with the package with vignettes, It includes vignettes for the users
devtools::build(vignettes = TRUE)
# creates  "/home/meglecz/vtamR_0.2.0.tar.gz"


# users
install.packages("https://github.com/meglecz/vtamR/releases/download/v0.2.0/vtamR_0.2.0.tar.gz",
                 repos = NULL,
                 type = "source")


# user
install.packages("vtamR_0.2.0.tar.gz", repos = NULL, type = "source")
...
# When building the readme, the Rmd and its chunks are executer, so all eaxme codes should work. If not, mahe eval=FALSE
