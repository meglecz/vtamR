...
Detailed documentation is available at **[Manual](https://meglecz.github.io/vtamR/)** 

- [Installation](https://meglecz.github.io/vtamR/articles/installation.html)
- [Short tutorial](https://meglecz.github.io/vtamR/articles/short-tutorial.html)
- [Detailed tutorial on how to construct a full metabarcoding pipeline.](https://meglecz.github.io/vtamR/articles/tutorial-vtamr-pipeline.html)
- [From fastq to data frame](https://meglecz.github.io/vtamR/articles/from-fastq-to-df.html)
- [How to make a mock_composition file](https://meglecz.github.io/vtamR/articles/make-mock-composition-file.html)
...
knitr::include_graphics("vignettes/figures/vtamR_flowchart_sceen.png")
```
...
⚠️ **Read the detailed installation instructions below before proceeding if you do not have experience with installing command line programs.** 
...
* CUTADAPT([Martin, 2011](https://journal.embnet.org/index.php/embnetjournal/article/view/200)) (v4.0)
...
If third-party executables are included in your `PATH`, 
...
[package options](https://meglecz.github.io/vtamR/articles/tutorial-vtamr-pipeline.html#set-path) 
in the beginning of yous script, or the full path to each program through the appropriate 
`vtamR` function argument (e.g., `vsearch_path`).
...
> **Note:** In Windows, double-clicking a `.zip` file doesn't actually decompress 
(extract) it — it just lets you browse the contents while they're still compressed.
>
...
If third-party executables are included in your 
...
**For other markers** you will need a [database formatted to BLAST](https://meglecz.github.io/vtamR/articles/tutorial-vtamr-pipeline.html#reference-database-for-taxonomic-assignments-with-assign_taxonomy_ltg), 
containing taxIDs and a 
[taxonomy file](https://meglecz.github.io/vtamR/articles/tutorial-vtamr-pipeline.html#reference-database-for-taxonomic-assignments-with-assign_taxonomy_ltg).
