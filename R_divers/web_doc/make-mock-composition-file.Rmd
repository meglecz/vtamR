---
title: "How to make a mock_composition file - v1.0.0"
auhor: Emese Meglécz
date:  "`r Sys.Date()`"
output: 
  html_document:
    ...
    toc_float: true
vignette: >
  %\VignetteIndexEntry{How to make a mock_composition file - v1.0.0}
...
although not essential for the `write_asv_table` function if you wish to add a column in 
...
read_count_file <- system.file("extdata/demo/8_FilterRenkonen.csv", package = "vtamR")
taxonomy <- system.file("extdata/db_test/taxonomy_reduced.tsv", package = "vtamR")
...
```{r}
asv_tax <- assign_taxonomy_ltg(asv=read_count_mock, 
                     taxonomy=taxonomy, 
                     blast_db=blast_db,
                     quiet=TRUE,
                     blast_path = blast_path 
...
asv_table_mock <- write_asv_table(read_count_mock, 
                               sampleinfo=sampleinfo, 
                               asv_tax=asv_tax,
