---
title: "Install vtamR and Third Party Programs - v1.1.0"
auhor: Emese Meglécz
date:  "`r Sys.Date()`"
output: 
  rmarkdown::html_vignette:
    ...
    toc_depth: 3
vignette: >
  %\VignetteIndexEntry{Install vtamR and Third Party Programs - v1.1.0}
...
Detailed documentation is available at **[Manual](https://people.imbe.fr/~emeglecz/vtamR)** 

- Installation
- Short tutorial
- Detailed tutorial on how to construct a full metabarcoding pipeline.
