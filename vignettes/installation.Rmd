...
If you intend to use the `TaxAssignRDP` function, which is needed to use RDP classifier
for taxonomic assignment of 16S markers, **install the rRDP and rRDPData** packages as well.
```{r install_github_rRDP, eval=FALSE}
