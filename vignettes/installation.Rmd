...
You also need to install Bioconductor packages manually
...
**Add the executables to your PATH** so you don’t need to type their full location each time.
...
You can add a directory to your PATH by editing your shell configuration file.

1. Edit your shell configuration file

Most Linux systems use **bash** or **zsh**.
...
```
  ...
  For zsh (if your system uses zsh)
...
```bash
export PATH="$PATH:/home/user/tools/myprogram/bin"
```
...
4. Verify that the programs are in your PATH
...
5. Click **Edit…**
6. Click **New**, then paste the directory you want to add (for example:
...
2. Close de Powershell, since the change applies only to **new** terminals, not the current one.
...
Alternatively, you can use the `TaxAssignRDP` function to assign bacterial 16S sequences.
