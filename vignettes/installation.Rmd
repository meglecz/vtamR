---
title: "Install vtamR and Third Party Programs - v0.3.1"
output: 
  rmarkdown::html_vignette:
    toc: true
    toc_depth: 3
vignette: >
  %\VignetteIndexEntry{Install vtamR and Third Party Programs - v0.3.1}
...
* `VSEARCH` (optional) [https://github.com/madler/pigz](https://github.com/madler/pigz)
...
For `TaxAssignLTG` (BLAST based Lowest Common Ancestor method),
...
`TaxAssignRDP` function uses de RDP algorithm to assign bacterial 16S sequences.
The database is provided in the `rRDPData` R data package.

It is also possible to provide to provide a trained classifier object created 
with `trainRDP()`.
