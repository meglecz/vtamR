---
title: "Short Tutorial vtamR - v1.0.4"
auhor: Emese Meglécz
date:  "`r Sys.Date()`"
output:
  html_document:
    ...
    toc_float: true
vignette: >
  %\VignetteIndexEntry{Short Tutorial vtamR - v1.0.4}
...
log_file <- file.path(outdir, "vtamR_log_zfzr.csv")
...
info_files = c(
  fastqinfo,
  "vtamR_demo_out/zfzr_plate1/1_merged/fastainfo.csv",
  "vtamR_demo_out/zfzr_plate1/2_random_seq/fastainfo.csv",
  "vtamR_demo_out/zfzr_plate1/3_demultiplexed/sampleinfo.csv"
)
read_count_files = c(
  "vtamR_demo_out/zfzr_plate1/4_filter/1_before_filter.csv",
  "vtamR_demo_out/zfzr_plate1/4_filter/2_swarm_denoise.csv",
  "vtamR_demo_out/zfzr_plate1/4_filter/14_filter_min_replicate.csv",
  "vtamR_demo_out/zfzr_plate1/4_filter/15_pool_replicates.csv",
  "vtamR_demo_out/zfzr_plate1/5_cluster/16_mOTU_vsearch.csv"
)
taxa = "vtamR_demo_out/zfzr_plate1/4_filter/assign_taxonomy_ltg.csv"
miem_results(
