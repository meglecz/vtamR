---
title: "From fastq to data frame - v1.0.0"
output: 
  rmarkdown::html_vignette:
    toc: true
    toc_depth: 3
vignette: >
  %\VignetteIndexEntry{From fastq to data frame - v1.0.0}
...
**merge_fastq_pairs fastq file pairs and quality filter reads**

```{r merge1}
sampleinfo_df <- merge_fastq_pairs(fastqinfo, 
                       fastq_dir=fastq_dir, 
...
Then the `demultiplex_and_trim` function will **[demultiplex](tutorial-vtamr-pipeline.html#glossary)** the fasta 
...
```{r demultiplex}
sampleinfo_df <- demultiplex_and_trim(fastainfo_df, 
                           fasta_dir=merged_dir, 
                           outdir=demultiplexed_dir, 
                           check_reverse=TRUE, 
                           cutadapt_path=cutadapt_path, # can be omitted if CUTADAPT is in the PATH
