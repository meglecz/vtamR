---
title: "From fastq to data frame - v0.3.0"
output: 
  html_document:
    toc: true
    toc_float: true
    toc_depth: 3
vignette: >
  %\VignetteIndexEntry{From fastq to data frame - v0.3.0}
...
[To compress or not to compress](tutorial-vtamr-pieline.html#to-compress-or-not-to-compress) for the best
...
**Merge fastq file pairs and quality filter reads**
Since the next step will be `TrimPrimer` using CUTADAPT, that handles correctly 
file compression, it is better to compress the output files.
